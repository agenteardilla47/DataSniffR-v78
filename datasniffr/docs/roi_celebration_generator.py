diff --git a/datasniffr/docs/roi_celebration_generator.py b/datasniffr/docs/roi_celebration_generator.py
--- a/datasniffr/docs/roi_celebration_generator.py
+++ b/datasniffr/docs/roi_celebration_generator.py
@@ -0,0 +1,327 @@
+#!/usr/bin/env python3
+"""
